                ...
                "hide" !== D
                    ? (L(this).hasClass("xdsoft_scroller_box") ||
                          ...
                          (g = function(e) {
                              var t = a(e).y - r + h;
                              t < 0 && (t = 0),
                                  t + u[0].offsetHeight > m &&
                                      (t = m - u[0].offsetHeight),
                ...
                (n = function(O) {
                    ...
                    F.find(".xdsoft_select")
                        ...
                        (_.setOptions = function(e) {
                            ...
                            (N = L.extend(!0, {}, N, e)),
                                ...
                                e.highlightedPeriods &&
                                    ...
                                    L.each(e.highlightedPeriods, function(
                                        e,
                                        t
                                    ) {
                                        var a, n, r, o, i, s, d;
                                ...
                                N.value &&
                                    (W.setCurrentTime(N.value),
                                    O && O.val && O.val(W.str)),
                                isNaN(N.dayOfWeekStart)
                                    ? (N.dayOfWeekStart = 0)
                                    : (N.dayOfWeekStart =
                                          parseInt(N.dayOfWeekStart, 10) % 7),
                                N.timepickerScrollbar ||
                                    u.xdsoftScroller(N, "hide"),
                                N.minDate &&
                                    /^[\+\-](.*)$/.test(N.minDate) &&
                                ...
                                N.minDateTime &&
                                    /^\+(.*)$/.test(N.minDateTime) &&
                                    (N.minDateTime = W.strToDateTime(
                                        N.minDateTime
                                    ).dateFormat(N.formatDate)),
                                N.maxDateTime &&
                                    /^\+(.*)$/.test(N.maxDateTime) &&
                                    (N.maxDateTime = W.strToDateTime(
                                        N.maxDateTime
                                    ).dateFormat(N.formatDate)),
                        ...
                        (W = new (function() {
                            ...
                            (r.now = function(e) {
                                ...
                                (r.getWeekOfYear = function(e) {
                                    if (
                                        N.onGetWeekOfYear &&
                                        L.isFunction(N.onGetWeekOfYear)
                                    ) {
                        ...
                        o
                            ...
                            .on("touchend mousedown.xdsoft", function() {
                                ...
                                !(function e(t) {
                                    ...
                                    o.hasClass(N.next) &&
                                    n - a - N.timeHeightInTimePicker >= r
                                        ? P.css(
                                              "marginTop",
                                              "-" +
                                                  (r +
                                                      N.timeHeightInTimePicker) +
                                                  "px"
                                          )
                                        : o.hasClass(N.prev) &&
                            ...
                            clearTimeout(t),
                                (t = setTimeout(function() {
                                    ...
                                    for (
                                        ...
                                        l +=
                                            "<th>" +
                                            N.i18n[R].dayOfWeekShort[
                                                (e + N.dayOfWeekStart) % 7
                                            ] +
                                            "</th>";
                                    for (
                                        l += "</tr></thead>",
                        ...
                        _.on("changedatetime.xdsoft", function(e) {
                            if (
                                N.onChangeDateTime &&
                                L.isFunction(N.onChangeDateTime)
                            ) {
                                var t = _.data("input");
                        ...
                        (r = function() {
                            ...
                            if (
                                ...
                                N.ownerDocument.documentElement.clientWidth -
                                    e.left <
